...
${OBJECTDIR}/Benutzer.o: Benutzer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Benutzer.o Benutzer.cpp

${OBJECTDIR}/CUI.o: CUI.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CUI.o CUI.cpp

${OBJECTDIR}/Catering.o: Catering.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Catering.o Catering.cpp

${OBJECTDIR}/Einladung.o: Einladung.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Einladung.o Einladung.cpp
...
${OBJECTDIR}/Mitarbeiter.o: Mitarbeiter.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Mitarbeiter.o Mitarbeiter.cpp

${OBJECTDIR}/Raum.o: Raum.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Raum.o Raum.cpp

${OBJECTDIR}/RaumVerwaltung.o: RaumVerwaltung.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/RaumVerwaltung.o RaumVerwaltung.cpp
